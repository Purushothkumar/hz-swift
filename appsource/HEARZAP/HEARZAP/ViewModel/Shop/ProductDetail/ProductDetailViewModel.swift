...
struct ProductDetailViewModel {
    func getCartList(canShowLoader: Bool, viewCon: ProductDetailViewController, subAPIUrl: String, methodName: String, parameter: String?, pageNumber: String?, retryAPIID: Int, strQuery: String?) {
    ...
    func postWishlist(canShowLoader: Bool, viewCon: ProductDetailViewController, subAPIUrl: String, methodName: String, parameter: String?, pageNumber: String?, retryAPIID: Int, strQuery: String?) {
        APIManager.shared.request(canShowLoader: canShowLoader, viewCon: viewCon, subAPIUrl: subAPIUrl, methodName: methodName, parameter: parameter, pageNumber: pageNumber, retryAPIID: retryAPIID, strQuery: strQuery) { result in
            do {
    ...
    func getAccessoriesList(canShowLoader: Bool, viewCon: ProductDetailViewController, subAPIUrl: String, methodName: String, parameter: String?, pageNumber: String?, retryAPIID: Int, strQuery: String?) {
        ...
        let view9 = viewCon.mainStackView.arrangedSubviews[9]// CM View
        let view10 = viewCon.mainStackView.arrangedSubviews[10]// Accessories title
        let view11 = viewCon.mainStackView.arrangedSubviews[11]// Accessories
        let view12 = viewCon.mainStackView.arrangedSubviews[12]// suggestion title
        let view13 = viewCon.mainStackView.arrangedSubviews[13]// suggestion
        ...
        let viewProductInfo5 = viewCon.productInfoStackView.arrangedSubviews[5]// empty
