...
struct AddUserViewModel {
    func postCustomerRelationAddPerson(canShowLoader: Bool, viewCon: AddUserViewController, subAPIUrl: String, methodName: String, parameter: String?, pageNumber: String?, retryAPIID: Int, strQuery: String?) {
        APIManager.shared.request(canShowLoader: canShowLoader, viewCon: viewCon, subAPIUrl: subAPIUrl, methodName: methodName, parameter: parameter, pageNumber: pageNumber, retryAPIID: retryAPIID, strQuery: strQuery) { result in
            do {
                let json = try JSONDecoder().decode(AddUserModel.self, from: result as Data)
                print(json)
                if viewCon.isFrom == IsNavigateFrom.addUser.rawValue {
                    viewCon.navigateBackToSelectUserViewController()
                } else if viewCon.isFrom == IsNavigateFrom.addUserProfile.rawValue {
    ...
    func postCustomerRelationGetPerson(canShowLoader: Bool, viewCon: AddUserViewController, subAPIUrl: String, methodName: String, parameter: String?, pageNumber: String?, retryAPIID: Int, strQuery: String?) {
        APIManager.shared.request(canShowLoader: canShowLoader, viewCon: viewCon, subAPIUrl: subAPIUrl, methodName: methodName, parameter: parameter, pageNumber: pageNumber, retryAPIID: retryAPIID, strQuery: strQuery) { result in
            do {
    ...
    func getCustomerRelationAddPerson(canShowLoader: Bool, viewCon: AddUserViewController, subAPIUrl: String, methodName: String, parameter: String?, pageNumber: String?, retryAPIID: Int, strQuery: String?) {
