//
//  BookAppointmentConfirmationViewController.swift
//  HEARZAP
//
...
class BookAppointmentConfirmationViewController: UIViewController {
    // MARK: - IBOutlets
    ...
    @IBOutlet var homeAddresslocationDescriptionLabel: Caption2FontLabel!
    ...
    // MARK: - Lets and Var
    var bookAppointmentConfirmationViewModel = BookAppointmentConfirmationViewModel()
    ...
    func setInitialView() {
        ...
        let view4 = self.mainStackView.arrangedSubviews[4]// address stack title
        let view5 = self.mainStackView.arrangedSubviews[5]// policy title
        let view6 = self.mainStackView.arrangedSubviews[6]// policy button
    ...
    func changeLanguageFormat() {
        self.titleLabel.text = AppLocalizationString.yourappointmenthasbeenscheduled
        ...
        self.onlineConsultationDetailsTitleLabel.text = AppLocalizationString.homeslashstorevisitdetails
        self.homeAddressTitleLabel.text = AppLocalizationString.home.capitalized
        self.storeAddressTitleLabel.text = AppLocalizationString.serviceStore.capitalized
        self.homeAddresslocationDescriptionLabel.text = AppLocalizationString.bookinglocationdesc
    ...
    func getBookingConfirmation(retryAPIID: Int, canShowLoader: Bool) {
        ...
        self.bookAppointmentConfirmationViewModel.getBookingConfirmation(canShowLoader: canShowLoader, viewCon: self, subAPIUrl: url, methodName: HTTPMethods.get, parameter: "", pageNumber: "", retryAPIID: retryAPIID, strQuery: "")
    }
    // MARK: - IBAction
    ...
    @IBAction func viewDetailsButtonPressed(_ sender: UIButton) {
        self.navigateToServiceRequestDetailViewController(isFrom: IsNavigateFrom.srdBookAppointmentSuccess.rawValue, bookingUid: self.bookingUid)
    }
    @IBAction func policyButtonPressed(_ sender: UIButton) {
        self.navigateToTermsConditionsViewController(isFrom: IsNavigateFrom.termsofUseBAConfirmation.rawValue)
    }
    // MARK: - Custom Method
...
extension BookAppointmentConfirmationViewController: ProtocolTitleNavigationBar {
...
extension BookAppointmentConfirmationViewController: ProtocolNetworkRechabilityDelegate {
    // MARK: - InternetError
...
extension BookAppointmentConfirmationViewController: UITableViewDelegate, UITableViewDataSource {
