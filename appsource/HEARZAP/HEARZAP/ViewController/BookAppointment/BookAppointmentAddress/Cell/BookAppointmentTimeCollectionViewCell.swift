//
//  BookAppointmentTimeCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolBookAppointmentTimeCollectionViewCell {
    func selectButtonPressedBookAppointmentTimeCollectionViewCell(senderTag: Int)
}

class BookAppointmentTimeCollectionViewCell: UICollectionViewCell {
    @IBOutlet var titleLabel: Caption1FontLabel!
    @IBOutlet var selectButton: Caption1FontLabel!
    
    var delegate: ProtocolBookAppointmentTimeCollectionViewCell?
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        self.delegate?.selectButtonPressedBookAppointmentTimeCollectionViewCell(senderTag: sender.tag)
    }
}
