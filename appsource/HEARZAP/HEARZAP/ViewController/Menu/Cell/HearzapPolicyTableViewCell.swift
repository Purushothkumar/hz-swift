//
//  HearzapPolicyTableViewCell.swift
//  HEARZAP
//
...
protocol ProtocolHearzapPolicyTableViewCell {
    func hearzapPolicyTableViewCellButtonPressed(senderTag: Int)
}

class HearzapPolicyTableViewCell: UITableViewCell {
    ...
    var delegate: ProtocolHearzapPolicyTableViewCell?
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        self.delegate?.hearzapPolicyTableViewCellButtonPressed(senderTag: sender.tag)
    }
}
