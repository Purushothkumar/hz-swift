//
//  CheckoutHomeAddressTableViewCell.swift
//  HEARZAP
//
...
protocol ProtocolCheckoutHomeAddressTableViewCell {
    func selectButtonPressedCheckoutHomeAddressTableViewCell(senderTag: Int)
}

class CheckoutHomeAddressTableViewCell: UITableViewCell {
    ...
    var delegate: ProtocolCheckoutHomeAddressTableViewCell?

    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
    }
    public func configure(address: AddressDatum, indexpath: Int, addressID: String) {
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        self.delegate?.selectButtonPressedCheckoutHomeAddressTableViewCell(senderTag: sender.tag)
