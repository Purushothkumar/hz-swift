//
//  CheckoutStoreAddressTableViewCell.swift
//  HEARZAP
//
...
protocol ProtocolCheckoutStoreAddressTableViewCell {
    func selectButtonPressedCheckoutStoreAddressTableViewCell(senderTag: Int)
}

class CheckoutStoreAddressTableViewCell: UITableViewCell {
    ...
    var delegate: ProtocolCheckoutStoreAddressTableViewCell?

    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
    }
    public func configure(storeDeliveryAddressModelStoreList: StoreDeliveryAddressModelStoreList, indexpath: Int, storeID: String) {
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        self.delegate?.selectButtonPressedCheckoutStoreAddressTableViewCell(senderTag: sender.tag)
    }
}
