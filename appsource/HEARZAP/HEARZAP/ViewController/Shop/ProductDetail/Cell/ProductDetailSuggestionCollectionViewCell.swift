//
//  ProductDetailSuggestionCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolProductDetailSuggestionCollectionViewCell {
...
class ProductDetailSuggestionCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolProductDetailSuggestionCollectionViewCell?
    ...
    public func configure(relatedProduct: RelatedProduct, indexpath: Int) {
        var product = ShopProductList()
        
        if relatedProduct.relatedProduct != nil {
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedProductDetailSuggestionCollectionViewCell(senderTag: sender.tag)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedProductDetailSuggestionCollectionViewCell(senderTag: sender.tag)
    }
}
