//
//  ViewAllProductCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolViewAllProductCollectionViewCell {
...
class ViewAllProductCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolViewAllProductCollectionViewCell?
    ...
    public func configure(product: ShopProductList, indexpath: Int) {
        ...
        self.productImageViewHeight.constant = CGFloat(239.38) * CGFloat(screenFrameWidth / AppConstantValue.defaultDesignScreenWidth)
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedViewAllProductCollectionViewCell(senderTag: sender.tag)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedViewAllProductCollectionViewCell(senderTag: sender.tag)
    }
}
