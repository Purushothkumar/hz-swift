//
//  AccessoriesSubcategoryProductCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolAccessoriesSubcategoryProductCollectionViewCell {
...
class AccessoriesSubcategoryProductCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolAccessoriesSubcategoryProductCollectionViewCell?
    ...
    public func configure(product: ShopProductList, indexpath: Int) {
        ...
        self.productImageViewHeight.constant = (239.38 * CGFloat(screenFrameWidth / AppConstantValue.defaultDesignScreenWidth))
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedAccessoriesSubcategoryProductCollectionViewCell(senderTag: sender.tag)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedAccessoriesSubcategoryProductCollectionViewCell(senderTag: sender.tag)
    }
}
