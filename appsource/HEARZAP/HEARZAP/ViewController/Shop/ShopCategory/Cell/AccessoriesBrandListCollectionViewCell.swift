//
//  AccessoriesBrandListCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolAccessoriesBrandListCollectionViewCell {
...
class AccessoriesBrandListCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolAccessoriesBrandListCollectionViewCell?
    var rowIndex: Int?
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedAccessoriesBrandListCollectionViewCell(rowIndex: self.rowIndex!, senderTag: sender.tag, viewCon: viewCon!)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedAccessoriesBrandListCollectionViewCell(rowIndex: self.rowIndex!, senderTag: sender.tag, viewCon: viewCon!)
    }
}
