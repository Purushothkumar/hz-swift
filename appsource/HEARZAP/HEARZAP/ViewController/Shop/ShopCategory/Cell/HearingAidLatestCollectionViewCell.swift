//
//  HearingAidLatestCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolHearingAidLatestCollectionViewCell {
...
class HearingAidLatestCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolHearingAidLatestCollectionViewCell?
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedHearingAidLatestCollectionViewCell(senderTag: sender.tag)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedHearingAidLatestCollectionViewCell(senderTag: sender.tag)
    }
}
