//
//  HearingAidBrandListCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolHearingAidBrandListCollectionViewCell {
...
class HearingAidBrandListCollectionViewCell: UICollectionViewCell {
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedHearingAidBrandListCollectionViewCell(rowIndex: self.rowIndex!, senderTag: sender.tag, viewCon: viewCon!)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedHearingAidBrandListCollectionViewCell(rowIndex: self.rowIndex!, senderTag: sender.tag, viewCon: viewCon!)
    }
}
