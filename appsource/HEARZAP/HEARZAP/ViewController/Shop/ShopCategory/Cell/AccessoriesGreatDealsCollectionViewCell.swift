//
//  AccessoriesGreatDealsCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolAccessoriesGreatDealsCollectionViewCell {
...
class AccessoriesGreatDealsCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolAccessoriesGreatDealsCollectionViewCell?
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedAccessoriesGreatDealsCollectionViewCell(senderTag: sender.tag)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedAccessoriesGreatDealsCollectionViewCell(senderTag: sender.tag)
    }
}
