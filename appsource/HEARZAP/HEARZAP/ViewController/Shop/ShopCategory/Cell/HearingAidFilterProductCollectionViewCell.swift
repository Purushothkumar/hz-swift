//
//  HearingAidFilterProductCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolHearingAidFilterProductCollectionViewCell {
...
class HearingAidFilterProductCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolHearingAidFilterProductCollectionViewCell?
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedHearingAidFilterProductCollectionViewCell(senderTag: sender.tag)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedHearingAidFilterProductCollectionViewCell(senderTag: sender.tag)
    }
}
