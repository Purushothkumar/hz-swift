//
//  HearingAidPriceListCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolHearingAidPriceListCollectionViewCell {
...
class HearingAidPriceListCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolHearingAidPriceListCollectionViewCell?
    var rowIndex: Int?
    ...
    public func configure(product: ShopProductList, indexpath: Int, rowIndex: Int, viewCon: ShopCategoryViewController) {
    ...
    @IBAction func wishlistButtonPressed(_ sender: UIButton) {
        self.delegate?.wishlistButtonPressedHearingAidPriceListCollectionViewCell(rowIndex: self.rowIndex!, senderTag: sender.tag, viewCon: self.viewCon!)
    }
    @IBAction func tapButtonPressed(_ sender: UIButton) {
        self.delegate?.tapButtonPressedHearingAidPriceListCollectionViewCell(rowIndex: self.rowIndex!, senderTag: sender.tag, viewCon: self.viewCon!)
    }
}
