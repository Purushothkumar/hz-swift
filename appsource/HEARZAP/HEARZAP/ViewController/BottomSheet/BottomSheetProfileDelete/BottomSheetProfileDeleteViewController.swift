//
//  BottomSheetProfileViewController.swift
//  HEARZAP
//
...
protocol ProtocolBottomSheetProfileViewControllerDelegate: AnyObject {
    func deleteButtonPressedBottomSheetProfileViewController(isDelete: Bool)
}
class BottomSheetProfileViewController: BottomPopupViewController {
    ...
    var protocolBottomSheetProfileViewControllerDelegate: ProtocolBottomSheetProfileViewControllerDelegate!
    ...
    @IBAction func deleteButtonPressed(_ sender: UIButton) {
        self.dismiss(animated: true) {
            self.protocolBottomSheetProfileViewControllerDelegate.deleteButtonPressedBottomSheetProfileViewController(isDelete: self.isDelete)
        }
    }
