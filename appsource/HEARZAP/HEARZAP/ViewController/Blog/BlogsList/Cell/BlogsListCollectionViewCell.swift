//
//  BlogsListCollectionViewCell.swift
//  HEARZAP
//
//  Created by Purushoth on 03/06/24.
//  Copyright © 2024 IZA MEDI TECHNOLOGIES. All rights reserved.
//

import UIKit
protocol ProtocolBlogsListCollectionViewCell {
    func tapButtonPressedBlogsListCollectionViewCell(senderTag: Int)
}
class BlogsListCollectionViewCell: UICollectionViewCell {
