//
//  StoreFinderHearzapDifferenceCollectionViewCell.swift
//  HEARZAP
//
...
class StoreFinderHearzapDifferenceCollectionViewCell: UICollectionViewCell {
    ...
    public func configure(hearzapDifference: StoreFinderDifferenceModelResult, indexpath: Int) {
