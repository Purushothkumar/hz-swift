//
//  ShareExperienceQuestionTableViewCell.swift
//  HEARZAP
//
...
class ShareExperienceQuestionTableViewCell: UITableViewCell {
    ...
    var questionid = ""
    var viewCon: ShareExperienceViewController = ShareExperienceViewController()
    ...
    public func configure(question: SurveyModelQuestion, indexpath: Int, selectArray: NSMutableArray, viewCon: ShareExperienceViewController) {
...
extension ShareExperienceQuestionTableViewCell: UITableViewDelegate, UITableViewDataSource {
    // MARK: - TableView Delegate
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.answerArray.count
    }
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: TableViewCellID.ShareExperienceAnswerTableViewCell, for: indexPath) as! ShareExperienceAnswerTableViewCell
...
extension ShareExperienceQuestionTableViewCell: ProtocolShareExperienceAnswerTableViewCell {
