...
class SurveyViewController: UIViewController {
    ...
    func changeLanguageFormat() {
        self.titlelabel.text = AppLocalizationString.quickSurvey
        self.descriptionlabel.text = AppLocalizationString.quickSurveyDescription
    ...
    func getSurveyList(retryAPIID: Int, canShowLoader: Bool) {
        ...
        self.surveyViewModel.getSurveyList(canShowLoader: canShowLoader, viewCon: self, subAPIUrl: url, methodName: HTTPMethods.get, parameter: "", pageNumber: "", retryAPIID: retryAPIID, strQuery: "")
    }
    func postSurveyList(retryAPIID: Int, canShowLoader: Bool) {
        ...
        self.surveyViewModel.postSurveyList(canShowLoader: canShowLoader, viewCon: self, subAPIUrl: url, methodName: HTTPMethods.post, parameter: param, pageNumber: "", retryAPIID: retryAPIID, strQuery: "")
    }
    // MARK: - IBAction
...
extension SurveyViewController: ProtocolLogoNavigationBar {
...
extension SurveyViewController: ProtocolNetworkRechabilityDelegate {
    // MARK: - InternetError
...
extension SurveyViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: TableViewCellID.SurveyQuestionTableViewCell, for: indexPath) as! SurveyQuestionTableViewCell
