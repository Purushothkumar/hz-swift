//
//  OnlineConsultationScheduleDateCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolOnlineConsultationScheduleDateCollectionViewCell {
    func selectButtonPressedOnlineConsultationScheduleDateCollectionViewCell(senderTag: Int)
}

class OnlineConsultationScheduleDateCollectionViewCell: UICollectionViewCell {
    ...
    var delegate: ProtocolOnlineConsultationScheduleDateCollectionViewCell?
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        self.delegate?.selectButtonPressedOnlineConsultationScheduleDateCollectionViewCell(senderTag: sender.tag)
    }
}
