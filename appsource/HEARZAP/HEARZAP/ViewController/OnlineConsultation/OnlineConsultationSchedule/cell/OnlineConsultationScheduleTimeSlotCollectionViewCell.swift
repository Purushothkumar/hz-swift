//
//  OnlineConsultationScheduleTimeSlotCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolOnlineConsultationScheduleTimeSlotCollectionViewCell {
    func selectButtonPressedOnlineConsultationScheduleTimeSlotCollectionViewCell(senderTag: Int)
}

class OnlineConsultationScheduleTimeSlotCollectionViewCell: UICollectionViewCell {
    @IBOutlet var titleLabel: Caption1FontLabel!
    @IBOutlet var selectButton: Caption1FontLabel!

    var delegate: ProtocolOnlineConsultationScheduleTimeSlotCollectionViewCell?
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        self.delegate?.selectButtonPressedOnlineConsultationScheduleTimeSlotCollectionViewCell(senderTag: sender.tag)
    }
}
