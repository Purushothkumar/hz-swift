//
//  OnlineConsultationMultiSelectCollectionViewCell.swift
//  HEARZAP
//
...
protocol ProtocolOnlineConsultationMultiSelectCollectionViewCell {
    func selectButtonPressedOnlineConsultationMultiSelectCollectionViewCell(senderTag: Int, rowIndex: Int)
}

class OnlineConsultationMultiSelectCollectionViewCell: UICollectionViewCell {
    @IBOutlet var titleLabel: Caption1FontLabel!
    @IBOutlet var imageview: UIImageView!
    @IBOutlet var selectButton: FootnoteOutlineButton!
    @IBOutlet var selectView: UIView!

    var delegate: ProtocolOnlineConsultationMultiSelectCollectionViewCell?
    var rowIndex: Int?
    ...
    func setEnableColor() {
        ...
        self.imageview.image = UIImage(named: Asset.concernlightblue)
    ...
    func setDisableColor() {
        ...
        self.imageview.image = UIImage(named: Asset.concerngrey)
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        self.delegate?.selectButtonPressedOnlineConsultationMultiSelectCollectionViewCell(senderTag: sender.tag, rowIndex: rowIndex!)
    }
}
