...
class AddUserViewController: UIViewController, UITextFieldDelegate {
    ...
    func getCustomerRelationAddPerson(retryAPIID: Int, canShowLoader: Bool) {
        self.addUserViewModel.getCustomerRelationAddPerson(canShowLoader: canShowLoader, viewCon: self, subAPIUrl: SubAPIUrl.getCustomerRelationAddPerson, methodName: HTTPMethods.get, parameter: "", pageNumber: "", retryAPIID: retryAPIID, strQuery: "")
    }
    func postCustomerRelationAddPerson(retryAPIID: Int, canShowLoader: Bool) {
        ...
        self.addUserViewModel.postCustomerRelationAddPerson(canShowLoader: canShowLoader, viewCon: self, subAPIUrl: SubAPIUrl.postCustomerRelationAddPerson, methodName: HTTPMethods.post, parameter: param, pageNumber: "", retryAPIID: retryAPIID, strQuery: "")
    }
    func postCustomerRelationGetPerson(retryAPIID: Int, canShowLoader: Bool) {
        let url = "\(SubAPIUrl.postCustomerRelationGetPerson)\(uid)/"
        self.addUserViewModel.postCustomerRelationGetPerson(canShowLoader: canShowLoader, viewCon: self, subAPIUrl: url, methodName: HTTPMethods.post, parameter: "", pageNumber: "", retryAPIID: retryAPIID, strQuery: "")
    }
    // MARK: - IBAction
...
extension AddUserViewController: ProtocolTitleNavigationBar {
...
extension AddUserViewController: ProtocolNetworkRechabilityDelegate {
    // MARK: - InternetError
...
extension AddUserViewController: ProtocolAddUserGenderCollectionViewCell {
