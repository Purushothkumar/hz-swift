//
//  CancelServiceRequestTableViewCell.swift
//  HEARZAP
//
...
class CancelServiceRequestTableViewCell: UITableViewCell {
    ...
    public func configure(reason: SRDModelCancelReasonList, indexpath: Int, selectID: String) {
    ...
    @IBAction func reasonButtonPressed(_ sender: UIButton) {
        self.delegate?.reasonButtonPressedCancelServiceRequestTableViewCell(senderTag: sender.tag)
    }
    func selectState() {
