...
class FiveDotCircleView: NibView {
    ...
    func setupView(button1image: String, button2image: String, button3image: String, button4image: String, button5image: String,circleViewBackgroundColor:UIColor) {
