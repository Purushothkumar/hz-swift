...
// MARK: - CartItemSpecificationModel
struct CartItemSpecificationModel: Codable {
    var statusCode: Int?
    var message: String?
    var data: CartItemSpecificationModelDataClass?
    var errors: Errors?
...
// MARK: - DataClass
struct CartItemSpecificationModelDataClass: Codable {
